...
let
  sources = {
    ...
    "elm-review-2.13.2" = {
      ...
      version = "2.13.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-review/-/elm-review-2.13.2.tgz";
        sha512 = "kI34BQ/EN1NC4KUcdZWAGNbaxWmR80kqJQRjT1ZmC0AyZRiJqdylhANucyzhPKEz60VGAkqau5axpySWXbdPLg==";
      };
    };
