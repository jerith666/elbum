...
let
  sources = {
    ...
    "elm-review-2.13.1" = {
      ...
      version = "2.13.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-review/-/elm-review-2.13.1.tgz";
        sha512 = "okkw5Mfmjkjy2ZggFyWfz5bpcd81fsQXGyNIDgZRFBU2vXao+xdt5/AN6L1tt6KWgjSyBJD94RXeyd5e3AhPKw==";
      };
    };
