...
let
  sources = {
    ...
    "elm-review-2.8.4" = {
      ...
      version = "2.8.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/elm-review/-/elm-review-2.8.4.tgz";
        sha512 = "oLIQa9C2eNs6VAu+KetZmkZBYf/zKDPUnQQ9Ft3lIrWT2M5wMQR9/vPHWnxTUsVPk7ufXowhG6WjGblJNRWpXw==";
      };
    };
